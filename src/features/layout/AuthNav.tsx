...
import { selectCartTotalItems } from "../cart/store/cart.selector";
...
export const AuthedNav: React.FC<AuthedNavProps> = ({ isNavbarWhite }) => {
  ...
  const totalCount = useSelector(selectCartTotalItems);
    ...
    <div className="flex items-center gap-2">
      <Link href="/cart" className="relative">
        ...
        >
          <Icon
            name="bag"
            className={cn("size-7", isNavbarWhite ? "text-black" : "text-white")}
          />
        </Button>
